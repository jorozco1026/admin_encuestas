...
<table width="726" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    while ($row_preguntas = pg_fetch_array($res_preguntas)){
     ...
     $car_codigoencuestas     = $row_preguntas["car_codigoencuestas"];
     $ind_codigoencuestas     = $row_preguntas["ind_codigoencuestas"];
    ...
    if ($pre_tippre_codigo != '00'){
     //if($car_codigoencuestas < 10) $car_codigoencuestas = '0'.$car_codigoencuestas;
     //if($ind_codigoencuestas < 10) $ind_codigoencuestas = '00'.$ind_codigoencuestas;
     //elseif($ind_codigoencuestas < 100) $ind_codigoencuestas = '0'.$ind_codigoencuestas;
     $codigoMostrar = $fac_codigo.'-'.$car_codigoencuestas.'-'.$ind_codigoencuestas;
